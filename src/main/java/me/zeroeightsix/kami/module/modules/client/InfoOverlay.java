...
public class InfoOverlay extends Module {
    ...
    public ArrayList<String> infoContents() {
        ...
        if (version.getValue()) {
            infoContents.add(getStringColour(setToText(firstColour.getValue())) + KamiMod.KAMI_KATAKANA + getStringColour(setToText(secondColour.getValue())) + " " + KamiMod.VER_SMALL);
